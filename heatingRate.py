...
t = numpy.linspace(0, timeRangeSeconds, 80)

heatingRateLinspace = numpy.linspace(150, 250, 2500)

#Excel initialization
book = xlsxwriter.Workbook('Heating_Rate.xlsx')
...
datasetA = []
datasetB = []
nitrogenFlowrate = 0.832653061 # flowrate at max yield 
