...
from model_diesel_27_fuzzysets import evaluationCreator
from model_diesel_27_fuzzysets import evaluate
from model_diesel_27_fuzzysets import generateFuzzyRules
from helpers import *
import xlsxwriter
...
def calculateConsequentParameters(data, OUTPUT_INDEX = 0):
  X = []
  Y = []
  for datum in data:
    X.append(
...
consequentParamsList = calculateConsequentParameters(data, DIESEL_FLOW)
consequentParamsListDataA = calculateConsequentParameters(datasetA, DIESEL_FLOW)
consequentParamsListDataB = calculateConsequentParameters(datasetB, DIESEL_FLOW)
