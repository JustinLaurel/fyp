from fuzzyYield.main import identifyFuzzyController
...
filename = os.path.join(dirname, '.\yield_data.xlsx')
...
tungstenHeatingRate = fuzzyController.evaluate([biomassMass])
