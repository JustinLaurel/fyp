...
def odes(
  ...
  if (1 < t < 30): tungstenTemp = 1400
  if (40 <= t < 75): tungstenTemp = 2200
  if (75 <= t < 100): tungstenTemp = 2600
...
book = xlsxwriter.Workbook('stepResponse_1.xlsx')
...
plot.title('Tungsten temperature = 2200K')
...
plot.legend()
plot.xticks(range(0, timeRangeSeconds, 5))
plot.ylim(0, 3400)
plot.show()
